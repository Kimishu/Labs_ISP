...
namespace Lab3
{
    ...
    abstract class HeroType : Hero
    {
        ...
        public delegate void HeroOutput(int NewLevel); 

        public event HeroOutput Output;

        public HeroType()
        {
            
            HeroOutput output = delegate (int NewLevel)
            {
                Console.Clear();
        ...
        public void HeroInfo(int NewLevel) => Output.Invoke(NewLevel);
    }
}
